...
# size_video1 = [3155849, 2641256, 2410258, 2956927, 2593984, 2387850, 2554662, 2964172, 2541127, 2553367, 2641109,
# 2876576, 2493400, 2872793, 2304791, 2855882, 2887892, 2474922, 2828949, 2510656, 2544304, 2640123, 2737436,
# 2559198, 2628069, 2626736, 2809466, 2334075, 2775360, 2910246, 2486226, 2721821, 2481034, 3049381, 2589002,
# 2551718, 2396078, 2869088, 2589488, 2596763, 2462482, 2755802, 2673179, 2846248, 2644274, 2760316, 2310848,
# 2647013, 1653424]
    ...
    while True:  # serve video forever
        ...
        for full_combo in CHUNK_COMBO_OPTIONS:
            ...
            for position in range(0, len(combo)):
                ...
                # download_time =
                # (get_chunk_size(chunk_quality, index)/1000000.) / future_bandwidth # this is MB/MB/s --> seconds

                download_time = net_env.get_download_time(
                    get_chunk_size(chunk_quality, index))  # poke env to get future download time
