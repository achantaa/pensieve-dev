    ...
    class Request_Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            if 'pastThroughput' in post_data:
                ...
                #         - REBUF_PENALTY * rebuffer_time / M_IN_K - np.abs(BITRATE_REWARD[post_data['lastquality']]
                ...
                try:
                    ...
                    state[4, -1] =\
                        np.minimum(video_chunk_remain, CHUNK_TIL_VIDEO_END_CAP) / float(CHUNK_TIL_VIDEO_END_CAP)
                    # default assumes that this is the first request, error is 0 since we have never predicted bandwidth
                    curr_error = 0
